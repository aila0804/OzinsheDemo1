...
//  OzinsheDemo1
//
//  Created by Aila Aila on 14.09.2025.
//
...
class LogOutViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    lazy var disagreeButton = {
        let button = UIButton()
        button.setTitle("Жок", for: .normal)
        button.setTitleColor(UIColor(red: 0.329, green: 0.082, blue: 0.776, alpha: 1), for: .normal)
        button.titleLabel?.font = UIFont (name: "SProDisplay-Semibold", size: 16)
    ...
    func setupUI() {
        ...
        backView.addSubviews(homeView, logOutLabel, questionLabel, agreeButton,
                             disagreeButton)
        ...
        logOutLabel.snp.makeConstraints { make in make.top.equalToSuperview().offset(58)
